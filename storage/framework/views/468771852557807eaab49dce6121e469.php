            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="needs-validation" novalidate action="/barang/<?php echo e($barang->id); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="nombre"  placeholder="Nombre cliente" value="<?php echo e(old('nombre', $barang->nombre)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="apellido" placeholder="apellido" value="<?php echo e(old('apellido', $barang->apellido)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="apellidoMat" placeholder="Apellido Materno" value="<?php echo e(old('apellidoMat', $barang->apellidoMat)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"  id="horario" value="<?php echo e(old('horario', $barang->horario)); ?> class="form-control <?php $__errorArgs = ['horario'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('modalidad', $barang->modalidad)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="direccion"  placeholder="Direccion" value="<?php echo e(old('direccion', $barang->direccion)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="telefono"  placeholder="Telefono" value="<?php echo e(old('telefono', $barang->telefono)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="observciones" placeholder="observciones" value="<?php echo e(old('observciones', $barang->observciones)); ?>" required>
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RacketClub\resources\views/barang/barang-edit.blade.php ENDPATH**/ ?>