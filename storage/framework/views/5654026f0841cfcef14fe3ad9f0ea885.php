...
<?php $__env->startSection('title', 'Venta de productos'); ?>
...
<div class="content-wrapper">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo e(route('storeVentaR')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    <input name="id_productoR" class="form-control" placeholder="Ingrese ID del producto">
                                </div>
                                <div class="form-group">
    ...
    document.querySelector('.btn-agregar').addEventListener('click', function() {
        let productId = document.querySelector('input[name="id_productoR"]').value;
        ...
        fetch('/productos/fetch-productR', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            },
            body: JSON.stringify({ id_productoR: productId })
        })
            ...
            if (data.error) {
                ...
                let productRow = `
                    <div class="product-row" data-id="${data.id_producto}">
                        <input type="hidden" name="productosR[${productIndex}][id_productoR]" value="${data.id_producto}">
                        <input type="hidden" name="productosR[${productIndex}][nombreR]" value="${data.nombre}">
                        <input type="hidden" name="productosR[${productIndex}][cantidadR]" value="1" class="input-cantidad">
                        <input type="hidden" name="productosR[${productIndex}][precioR]" value="${data.precio}">
                    </div>
                `;
                ...
                // Agregar el evento para el botón "Quitar" solo a los nuevos botones
                tableBody.lastElementChild.querySelector('.btn-quitar').addEventListener('click', quitarProducto);
            }
        });
    });
    </script>
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RacketClub\resources\views/productos/ventaProductosR.blade.php ENDPATH**/ ?>