...
<?php $__env->startSection('title', 'Añadir Reserva'); ?>
...
unset($__errorArgs, $__bag); ?>" id="fecha" placeholder="Fecha" value="<?php echo e(old('fecha')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="hora" placeholder="Hora de reserva " value="<?php echo e(old('hora')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="cancha" placeholder="Nro Cancha" value="<?php echo e(old('cancha')); ?>" required>
...
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RacketClub\resources\views/ReservarCanchas/reservaCanchas-add.blade.php ENDPATH**/ ?>